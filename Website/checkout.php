...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="style1n.css">
      ...
      <form action="bill.php">
        ...
        <div >
          <div >
            ...
            <input type="text" id="fname" name="firstname" placeholder="nipun madhushan">
            <br>
            <label for="email"><i class="fa fa-envelope"></i> Email</label>
            <input type="text" id="email" name="email" placeholder="abcdef@example.com">
            <br>
            <label for="adr"><i class="fa fa-address-card-o"></i> Address</label>
            <input type="text" id="adr" name="address" placeholder="569/4 15th Street">
            <br>
            ...
            <div >
              ...
              <div class="col-50">
                ...
                <input type="text" id="zip" name="zip" placeholder="80400">
              </div>
            </div>
          </div>
        ...
        <label>
          <input type="checkbox" checked="checked" name="sameadr"  > pay cash on delivary
        </label>
        <br>
