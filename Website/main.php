...
<link rel="shortcut icon" href="img/logo.jpg">
 ...
 <link rel="stylesheet"
href="https://maxcdn.bootstrapcdn.com/bootstrap/4.1.1/css/bootstrap.min.
css">
 <script
...
data-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" ariaexpanded="false" aria-label="Toggle navigation">
...
class="txtsearch" />
<input type="button" class="btsearch"
value="Search">
</form>
</nav>
<div class="container">
...
<img src="<?php echo $row['P_filepath']?>"
class="img-rounded" height="200" />
<div class="drate"><?php echo
$row["P_Offers"]; ?>% off</div>
<div class="overlay">
...
echo'<span style="color:#fff;text-align:center;">No
promotions available at the moment</span>';
}
?>
</div>
</div>
...
>>>>>>> 84cffa697e92836e9ae9b9c095ff4983ceb42bbc
...
<h3>About Us</h3>
<p>bla bla bla nipun bla bla bla
nipun bla</p>
</div>
</div>
<div class="col-md-4 col-sm-6">
...
<ul class="link-area">
<li><i class="fa
fa-phone">+94757170784</i></li>
<li><i class="fa
fa-envelope">nipun@nipunspice.lk</i></li>
<li><i class="fa
fa-map">390/3 Kurudugaha hathekma, Elpitiya</i></li>
</ul>
</div>
</div>
<div class="col-md-4 col-sm-6">
...
<li class="dinline-flex"><a href="https://www.facebook.com/nipun.madushan.7946"><i
class="fab fa-facebook-square" aria-hidden="true"></i></a></li>
<li class="d-
inline-flex"><a href="https://instagram.com/nipun_spice_export?
igshid=ldicgud9hfuz"><i class="fab fa-instagram"></i></a></li>
<li class="dinline-flex"><a href="https://www.youtube.com/channel/UCPeNPHARSfDSSgHuLT64rA"><i class="fab fa-youtube-square"></i></a></li>
 </ul>
